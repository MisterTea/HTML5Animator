...
public class UserSession implements org.apache.thrift.TBase<UserSession, UserSession._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField ACCESS_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("accessTime", org.apache.thrift.protocol.TType.I64, (short)128);
  ...
  public long accessTime; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ACCESS_TIME((short)128, "accessTime");
  ...
  private static final int __ACCESSTIME_ISSET_ID = 2;
  ...
  public UserSession setAccessTime(long accessTime) {
    this.accessTime = accessTime;
    setAccessTimeIsSet(true);
    return this;
  }
  ...
  public void unsetAccessTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ACCESSTIME_ISSET_ID);
  }

  /** Returns true if field accessTime is set (has been assigned a value) and false otherwise */
  public boolean isSetAccessTime() {
    return EncodingUtils.testBit(__isset_bitfield, __ACCESSTIME_ISSET_ID);
  }

  public void setAccessTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ACCESSTIME_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ACCESS_TIME:
      return Long.valueOf(getAccessTime());
  ...
  public boolean equals(UserSession that) {
    ...
    boolean this_present_accessTime = true;
    boolean that_present_accessTime = true;
  ...
  public int compareTo(UserSession other) {
    ...
    lastComparison = Boolean.valueOf(isSetAccessTime()).compareTo(typedOther.isSetAccessTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAccessTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.accessTime, typedOther.accessTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserSession struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 128: // ACCESS_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.accessTime = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserSession struct) throws org.apache.thrift.TException {
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter48 : struct.data.entrySet())
          {
      ...
      oprot.writeI64(struct.accessTime);
      oprot.writeFieldEnd();
      ...
      if (struct.isSetData()) {
        {
          ...
          for (Map.Entry<String, String> _iter49 : struct.data.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.data = new HashMap<String,String>(2*_map50.size);
